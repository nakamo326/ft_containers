...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  template <typename _Key,
            ...
            typename _Compare,
            typename _Alloc>
  pair<typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::
           const_iterator,
  ...
  template <typename _Key,
            ...
            typename _Compare,
            typename _Alloc>
  void _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::swap(_Rb_tree &
                                                                 __t) {
    if (_M_root() == 0) {
      if (__t._M_root() != 0)
  ...
  _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_insert_unique(
    ...
    if (__res.second) {
      ...
      return _Res(
          _M_insert_(
              __res.first, __res.second, _GLIBCXX_FORWARD(_Arg, __v), __an),
          true);
    }
  ...
  _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_insert_unique_(
    ...
    if (__res.second)
      return _M_insert_(
          __res.first, __res.second, _GLIBCXX_FORWARD(_Arg, __v), __node_gen);

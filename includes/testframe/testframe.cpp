...
#include "../../srcs/tests/map_test.cpp"
#include "../../srcs/tests/pair_test.cpp"
#include "../../srcs/tests/set_test.cpp"
#include "../../srcs/tests/stack_test.cpp"
#include "../../srcs/tests/vector_test.cpp"
